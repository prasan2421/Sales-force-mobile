                        ...
                        <View style={{width:'100%',justifyContent:'center'}}>
                            ...
                            <View style={{paddingLeft:10,paddingBottom:10,flexDirection:'row'}}>
                                <TouchableOpacity
                                    ...
                                    //     }
                                    // )}
                                    style={{backgroundColor:'#00daff',padding:5,borderRadius:5,marginRight:10}}><Text style={{color:'#fff'}}>Detail</Text>
                                </TouchableOpacity>
                                <TouchableOpacity
                                    // onPress={()=>this.props.navigation.navigate('EditOrder',{
                                    //     ID:item._id
                                    // })}
                                    style={{backgroundColor:'#0a2dff',padding:5,borderRadius:5,marginRight:10}}><Text style={{color:'#fff'}}>Edit</Text>
                                </TouchableOpacity>
                                <TouchableOpacity
                                    // onPress={()=>this.requestStoragePermission(item._id)}
                                    style={{backgroundColor:'#2aab10',padding:5,borderRadius:5,marginRight:10}}><Text style={{color:'#fff'}}>Download</Text>
                                </TouchableOpacity>
                                <TouchableOpacity
                                    ...
                                    // })}
                                    style={{backgroundColor:item.invoice_id==''?'#ffc504':'#ff8400',padding:5,borderRadius:5,marginRight:10}}><Text style={{color:'#fff'}}>{item.invoice_id==''?'Add Invoice':'Invoice Detail'}</Text>
                                </TouchableOpacity>
                            </View>
                        </View>
                    </TouchableHighlight>}
