        ...
        return (
            <ScrollView style={{backgroundColor:'#ebeef3'}}>
                ...
                <ActivityIcon visible={this.state.isLoading}
                              ...
                              messageColor={'#afafaf'}
                              message='Please wait, Saving order...'
                />

                <View style={{width:'100%',marginBottom:10,marginTop:10,alignItems: 'center'}}>
                    <View style={{justifyContent:'space-between',width:'95%',backgroundColor:'#fff',padding:5,borderRadius:5,elevation:1}}>
                ...
                <View style={{width:'100%',marginBottom:10,alignItems: 'center'}}>
                    ...
                    <View style={styles.buttonWrapper}>
                        ...
                        <TouchableHighlight onPress={this.Submit}
                         style={{ backgroundColor:'#ff1f77',
                          padding:10,
                            borderRadius:20,
                           }}>
                            <Text style={styles.buttonText}>{'Save & Send Mail'}</Text>
                        </TouchableHighlight>

                        <TouchableHighlight onPress={this.Submit1} style={{ backgroundColor:'#ff1f77',
                            marginLeft:10,
                            padding:10,
                            borderRadius:20,
                        }}>
