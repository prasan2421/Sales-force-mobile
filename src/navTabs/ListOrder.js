            ...
            <FlatList
                ...
                renderItem={({item})=>
                    <TouchableHighlight
                        ...
                        onPress={() => this.props.navigation.navigate('ListOrderDetail',
                            {
                                ID: item._id,
                            }
                    ...
                    >
                            <View style={{width:'90%', height:80,backgroundColor:'#ffffff', alignItems:'center',justifyContent:'center'}}>
                                <View  style={{padding:5,}}>
                                    <Text style={{fontSize:12}}>{item.customer}</Text>
                                </View>
                            </View>
